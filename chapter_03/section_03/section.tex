...
\subsubsection{Connection Block Diagram}
...
\begin{figure} [H]
    ...
    \includegraphics [
        ...
        max height = \IGXMaxHeight,
        \IGXDefaultOptionalArgs,
    ] {pics/stm_uart_main_flow.pdf}
    \captionof{figure} {Flow of main task / thread.}
    \label{fig:uartMainFlow}
\end{figure}

\subsubsection{ISR Task Flow}
...
\begin{figure} [H]
    ...
    \includegraphics [
        ...
        max height = \IGXMaxHeight,
        \IGXDefaultOptionalArgs,
    ] {pics/stm_uart_isr_flow.pdf}
    \captionof{figure} {Flow of ISR task / thread.}
    \label{fig:uartISRFlow}
\end{figure}
