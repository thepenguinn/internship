...
\definecolor{colorPastelGreen} {HTML} {000000}
...
{\bfseries\normalfont\huge\filright\sffamily\vspace{-3.5cm}}
{\color{colorNonSunDark} \Large\texttt{{\week} \hfill \weekRange} \vspace{0.65em}}
{1pc}
{\color{colorNonSunDark}\titlerule\vspace{0.65em}\scshape\centering\color{colorNonSunDark}}
[\color{colorNonSunDark}\vspace{0.65em}{\titlerule[1pt]}]

\titleformat{\section}
{\vspace{-0.35em}\ttfamily\Large\filright}
{\thesection}
{8pt}
{\scshape}
{}
